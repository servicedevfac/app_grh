...
@section('title','création de departement')
@section('content')
 ...
 <section class="row">
        <div class="col-12 col-lg-12">
            <div class="container py-5">
                ...
                <form action="{{ route('departement.create') }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-sm">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary w-100">Créer le département</button>
                </form>
