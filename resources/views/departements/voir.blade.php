...
@section('title', 'Modifier un departement')
@section('content')
                            ...
                            <div class="tab-content m-0 p-4">
                                ...
                                <div id="edit-profile" class="tab-pane active">
                                    <div class="user-profile-content">
                                        <form action="{{ route('departement.update', $departements->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row  row-cols-1">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="description" id="description" class="form-control">{{ $departements->description }}</textarea>
                                                    @error('description')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <select name="responsable_id" id="responsable_id" class="form-select">
                                                        ...
                                                        @foreach($employes as $employe)
                                                            <option value="{{ $employe->id }}"
                                                                {{ (old('responsable_id', $departement->responsable_id ?? '') == $employe->id) ? 'selected' : '' }}>
