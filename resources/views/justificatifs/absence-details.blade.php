                    ...
                    <div class="card-body p-0">
                        <div class="profile-content">
                            <ul class="nav nav-underline nav-justified gap-0">
                                ...
                                @php
                                    $isApproved = in_array($absence->statut, ['validee','rejetee']);
                                @endphp
                            ...
                            <div class="tab-content m-0 p-4">
                                <div class="tab-pane active" id="aboutme" role="tabpanel"
                                    ...
                                    <div class="profile-desk">
                                        {{-- <h5 class="text-uppercase fs-16 ">Nom et prenom : <b class="text-dark fs-16 lowercase">{{ ucfirst($absence->employe->nom) }} {{ ucfirst($absence->employe->prenom) ?? '_' }} </b></h5> <br>
                                        <div class="designation mb-4"> 
                                            <h5 class="text-uppercase fs-16 ">Type d'absence : <b class="text-dark text-lowercase fs-16"> {{ ($absence->type_absence) ?? '_' }} </b></h5><br>
                                            <h5 class="text-uppercase fs-16 ">Date d'absence : <b class="text-dark text-lowercase fs-16"> {{ ($absence->date_absence)->format('d/m/Y') ?? '_' }} </b></h5><br>
                                            <h5 class="text-uppercase fs-16 ">Motif : <b class="text-dark text-lowercase fs-16"> {{ ($absence->motif ?? '_') }} </b></h5><br>
                                            <h5 class="text-uppercase fs-16 ">Statut de la demande : <b class="text-dark text-lowercase fs-16"> {{ ($absence->statut ?? '_') }} </b></h5><br>
                                ...
                                <div id="edit-profile" class="tab-pane">
                                    <div class="user-profile-content">
                                        ...
                                        @endphp
                                        <form action="{{ route('absences.resubmit', $absence->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')

                                            {{-- Type de absencé --}}
                                            <label for="type" class="form-label">Type d'absence</label>
                                            <select name="type_absence" id="type" class="form-control" required {{ $disabled }}>
                                            ...
                                            {{-- Motif --}}
                                            <label>Motif</label>
                                            <textarea name="motif" class="form-control" {{ $disabled }}>{{ old('motif', $absence->motif) }}</textarea>
                                            <br>

                                            {{-- Justificatif --}}
                                            <label>Justificatif</label>
                                            <input type="file" name="justificatif" class="form-control" {{ $disabled }}>
                                            <br>
