...
@section('content')
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="mb-4 text-start">Mes demandes d'Absences</h2>
            <a href="{{ route('justificatifs.absence') }}" class="btn btn-primary mb-3 ">Justifié mon absence</a>
        </div>
            @if ($absences->isEmpty())
                <p class="text-center">Aucune demande de justificatifs d'absences trouvé.</p>
            @else
                            ...
                            <tbody>
                                @foreach ($absences as $index => $absence)
                                    <tr>
                                        ...
                                        <td> 
                                            <a href="{{ route('absences.details',$absence->id ) }}" class="btn btn-sm btn-info">
                                                Voir
                                            </a>
